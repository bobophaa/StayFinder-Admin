                ...
                <tr v-for="b in recentBookings" :key="b.id">
                  ...
                  <td>
                    <div class="d-flex gap-1" v-if="isPending(b.status)">
                      <button class="btn-action approve" @click="approveBooking(b.id)" :disabled="actionId === b.id" title="Approve">
                        <i class="bi bi-check-lg"></i>
                      </button>
                      <button class="btn-action reject" @click="rejectBooking(b.id)" :disabled="actionId === b.id" title="Reject">
                ...
                <tr v-for="r in recentRents" :key="r.id">
                  ...
                  <td>
                    <div class="d-flex gap-1" v-if="isPending(r.status)">
                      <button class="btn-action approve" @click="approveRent(r.id)" :disabled="actionId === r.id" title="Approve">
                        <i class="bi bi-check-lg"></i>
                      </button>
                      <button class="btn-action reject" @click="rejectRent(r.id)" :disabled="actionId === r.id" title="Reject">
                        <i class="bi bi-x-lg"></i>
                      </button>
                    </div>
                    <span v-else class="text-muted small">–</span>
                  ...
                  <td class="ps-4">
                    <div class="d-flex align-items-center gap-2">
                      <div class="room-thumb">
                        ...
                        <i v-else class="bi bi-building text-muted" style="font-size:.8rem"></i>
                      </div>
          ...
          <div class="d-flex flex-column gap-2">
            <router-link v-for="a in quickActions" :key="a.to" :to="a.to" class="action-box text-decoration-none">
              ...
              <div>
                ...
                <div class="text-muted" style="font-size:.72rem">{{ a.sub }}</div>
              </div>
