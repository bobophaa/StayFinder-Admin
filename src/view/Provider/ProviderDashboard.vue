<template>
  <div class="container-fluid py-3 px-md-4 font-kh">
    <!-- ── Header ── -->
    <div class="d-flex justify-content-between align-items-start mb-4 flex-wrap gap-2">
      <div>
        <h2 class="fw-bold text-navy mb-1">
<<<<<<< HEAD
          សូមស្វាគមន៍, {{ authStore.user?.name?.split(' ')[0] || 'ម្ចាស់' }}
        </h2>
        <p class="text-muted mb-0">
          គ្រប់គ្រងបញ្ជីរបស់អ្នកនៅ <span class="fw-bold text-navy">StayFinder</span> —
...
<<<<<<< HEAD
            <small class="text-muted fw-semibold stat-label">បន្ទប់ដែលជួល</small>
=======
...
<<<<<<< HEAD
            <i class="bi bi-bar-chart-fill me-2 text-orange"></i>ទិដ្ឋភាពការកក់ និងការជួល
=======
...
>>>>>>> d1ee42068b953396e964b2b4818804dc6f924368
            ...
            <div>
              <div class="d-flex justify-content-between mb-1">
<<<<<<< HEAD
                <span class="small fw-semibold text-navy"><i class="bi bi-check-circle-fill me-2 text-success"></i>ការកក់ដែលបានអនុម័ត</span>
=======
...
>>>>>>> d1ee42068b953396e964b2b4818804dc6f924368
              ...
              <div class="progress" style="height: 8px; border-radius: 10px; background: #f0f2f5">
                <div class="progress-bar bg-success" style="border-radius: 10px" :style="{ width: barPct(approvedBookings, bookings.length) + '%' }"></div>
              </div>
            </div>
            <div>
              <div class="d-flex justify-content-between mb-1">
...
>>>>>>> d1ee42068b953396e964b2b4818804dc6f924368
            ...
            <div>
              <div class="d-flex justify-content-between mb-1">
<<<<<<< HEAD
                <span class="small fw-semibold text-navy"><i class="bi bi-house-check-fill me-2 text-info"></i>ការជួលដែលបានអនុម័ត</span>
=======
...
>>>>>>> d1ee42068b953396e964b2b4818804dc6f924368
              ...
              <div class="progress" style="height: 8px; border-radius: 10px; background: #f0f2f5">
                <div class="progress-bar bg-info" style="border-radius: 10px" :style="{ width: barPct(approvedRents, rents.length) + '%' }"></div>
              </div>
            </div>
          </div>
...
<<<<<<< HEAD
                <div class="text-muted" style="font-size: 0.7rem">ការកក់សរុប</div>
=======
...
<<<<<<< HEAD
                <div class="text-muted" style="font-size: 0.7rem">ការជួលសរុប</div>
=======
...
<<<<<<< HEAD
                ...
                <div class="text-muted" style="font-size: 0.7rem">ត្រូវការសកម្មភាព</div>
=======
...
>>>>>>> d1ee42068b953396e964b2b4818804dc6f924368
      ...
      <div class="col-lg-4">
        <div class="card border-0 shadow-sm rounded-4 p-4 h-100">
          <h5 class="fw-bold text-navy mb-4">
<<<<<<< HEAD
            <i class="bi bi-pie-chart-fill me-2 text-orange"></i>ចំណែកបន្ទប់
=======
          ...
          <div class="d-flex justify-content-center mb-3">
            <div class="donut-wrap position-relative">
              <svg viewBox="0 0 36 36" class="donut-svg">
                ...
                <circle class="donut-segment seg-active" cx="18" cy="18" r="15.9"
                  :stroke-dasharray="`${roomStats.active} ${100 - roomStats.active}`" stroke-dashoffset="25" />
              ...
              <div class="donut-center">
                ...
                <div class="text-muted" style="font-size: 0.65rem">សរុប</div>
              </div>
            </div>
          </div>
...
<<<<<<< HEAD
            ...
            <div class="d-flex justify-content-between">
              <span class="d-flex align-items-center gap-2 small"><span class="legend-dot" style="background: #ff5f00"></span>មានការបញ្ចុះតម្លៃ</span>
=======
              <span class="d-flex align-items-center gap-2 small"><span class="legend-dot" style="background:#198754"></span>សកម្ម</span>
              <span class="fw-bold text-navy small">{{ roomStats.active }}%</span>
            </div>
...
<<<<<<< HEAD
            <div class="text-muted small mb-1">តម្លៃជួលមធ្យម</div>
            <div class="fw-bold text-orange" style="font-size: 1.4rem">{{ avgPrice }}</div>
            <div class="text-muted" style="font-size: 0.72rem">ក្នុងមួយខែ</div>
=======
...
<<<<<<< HEAD
              <span v-if="pendingBookings > 0" class="badge-count">{{ pendingBookings }} កំពុងរង់ចាំ</span>
=======
              ...
              <tbody>
                <tr v-for="b in recentBookings" :key="b.id">
                  <td class="ps-4">
                    ...
                    <div class="text-muted" style="font-size: 0.72rem">{{ b.buyer?.name || b.user?.name || '–' }}</div>
                  </td>
                  ...
                  <td>
                    <div class="d-flex gap-1" v-if="isPending(b.status)">
                      <button class="btn-action approve" @click="approveBooking(b.id)" :disabled="actionId === b.id" title="អនុម័ត"><i class="bi bi-check-lg"></i></button>
                      <button class="btn-action reject" @click="rejectBooking(b.id)" :disabled="actionId === b.id" title="បដិសេធ"><i class="bi bi-x-lg"></i></button>
                    </div>
      ...
      <div class="col-lg-6">
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
          <div class="card-header-navy px-4 py-3 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2 align-items-center">
<<<<<<< HEAD
              <span v-if="pendingRents > 0" class="badge-count">{{ pendingRents }} កំពុងរង់ចាំ</span>
=======
              ...
              <tbody>
                <tr v-for="r in recentRents" :key="r.id">
                  <td class="ps-4">
                    ...
                    <div class="text-muted" style="font-size: 0.72rem">{{ r.buyer?.name || r.user?.name || '–' }}</div>
                  </td>
                  ...
                  <td>
                    <div class="d-flex gap-1" v-if="isPending(r.status)">
                      <button class="btn-action approve" @click="approveRent(r.id)" :disabled="actionId === r.id" title="អនុម័ត"><i class="bi bi-check-lg"></i></button>
                      <button class="btn-action reject" @click="rejectRent(r.id)" :disabled="actionId === r.id" title="បដិសេធ"><i class="bi bi-x-lg"></i></button>
                    </div>
                    <span v-else class="text-muted small">–</span>
                  </td>
                </tr>
          ...
          <div class="table-responsive" v-else>
            <table class="table table-hover align-middle mb-0">
              <thead class="table-light">
                <tr>
<<<<<<< HEAD
                  <th class="ps-4 small fw-bold text-muted">បន្ទប់</th>
                  <th class="small fw-bold text-muted">ខណ្ឌ</th>
                  <th class="small fw-bold text-muted">តម្លៃ</th>
                  <th class="small fw-bold text-muted">ស្ថានភាព</th>
                  <th class="small fw-bold text-muted">កែប្រែ</th>
=======
                ...
                <tr v-for="room in myRooms.slice(0, 6)" :key="room.id">
                  <td class="ps-4">
                    <div class="d-flex align-items-center gap-2">
                      ...
                      <span class="fw-semibold small text-navy text-truncate" style="max-width: 120px">{{ room.title }}</span>
                    </div>
                  </td>
                  ...
                  <td>
<<<<<<< HEAD
                    <router-link :to="`/provider/edit-room/${room.id}`" class="btn-action edit" title="កែប្រែ">
=======
...
<<<<<<< HEAD
          ...
          <div class="d-flex justify-content-between mb-3">
            ...
            <span class="badge" style="background: rgba(255,95,0,0.12); color: #ff5f00; font-size: 0.7rem; font-weight: 800;">ម្ចាស់ផ្ទះជួល</span>
=======
...
>>>>>>> d1ee42068b953396e964b2b4818804dc6f924368
          ...
          <div class="d-flex justify-content-between mb-3">
<<<<<<< HEAD
            <span class="small text-muted">តម្លៃមធ្យម</span>
            <span class="fw-bold text-navy">{{ avgPrice }}</span>
          </div>
          <div class="d-flex justify-content-between mb-3">
            <span class="small text-muted">សកម្មភាពដែលរង់ចាំ</span>
            <span class="fw-bold" style="color: #f59e0b">{{ pendingBookings + pendingRents }}</span>
          </div>
          <div class="d-flex justify-content-between mb-4">
            <span class="small text-muted">ត្រូវបានអនុម័តសរុប</span>
...
const statusLabel  = (s) => ({ pending: 'កំពុងរង់ចាំ', approved: 'បានអនុម័ត', rejected: 'បានបដិសេធ' })[getStatusKey(s)]
...
const quickActions = [
<<<<<<< HEAD
  { to: '/provider/my-rooms',       title: 'បន្ទប់របស់ខ្ញុំ',      sub: 'មើល និងគ្រប់គ្រងបញ្ជី',   icon: 'bi-house-door-fill',     bg: 'bg-orange-light',  color: '#ff5f00' },
  { to: '/provider/add-room',       title: 'បន្ថែមបន្ទប់ថ្មី',      sub: 'បន្ថែមបញ្ជីថ្មី',           icon: 'bi-plus-circle-fill',    bg: 'bg-success-light', color: '#198754' },
  { to: '/provider/booking-check',  title: 'ការស្នើសុំកក់',          sub: 'អនុម័ត ឬ បដិសេធ',          icon: 'bi-calendar-check-fill', bg: 'bg-primary-light', color: '#0d6efd' },
  { to: '/provider/rent-check',     title: 'ការស្នើសុំជួល',          sub: 'អនុម័ត ឬ បដិសេធ',          icon: 'bi-house-check-fill',    bg: 'bg-purple-light',  color: '#8b5cf6' },
  { to: '/provider/profile',        title: 'ប្រវត្តិរូបរបស់ខ្ញុំ',   sub: 'កែប្រែព័ត៌មានគណនី',        icon: 'bi-person-fill',         bg: 'bg-navy-light',    color: '#031c36' },
]

const approveBooking = async (id) => {
  actionId.value = id
  try { await api.put(`/books/approve/${id}`); const b = bookings.value.find((x) => x.id === id); if (b) b.status = 2; showToast('បានអនុម័តការកក់!') }
  catch (e) { showToast(e.response?.data?.message || 'បរាជ័យ', 'error') }
  finally { actionId.value = null }
}
const rejectBooking = async (id) => {
  actionId.value = id
  try { await api.put(`/books/reject/${id}`); const b = bookings.value.find((x) => x.id === id); if (b) b.status = 3; showToast('បានបដិសេធការកក់។') }
  catch (e) { showToast(e.response?.data?.message || 'បរាជ័យ', 'error') }
  finally { actionId.value = null }
}
const approveRent = async (id) => {
  actionId.value = id
  try { await api.put(`/rents/approve/${id}`); const r = rents.value.find((x) => x.id === id); if (r) r.status = 2; showToast('បានអនុម័តការជួល!') }
  catch (e) { showToast(e.response?.data?.message || 'បរាជ័យ', 'error') }
  finally { actionId.value = null }
}
const rejectRent = async (id) => {
  actionId.value = id
  try { await api.put(`/rents/reject/${id}`); const r = rents.value.find((x) => x.id === id); if (r) r.status = 3; showToast('បានបដិសេធការជួល។') }
  catch (e) { showToast(e.response?.data?.message || 'បរាជ័យ', 'error') }
  finally { actionId.value = null }
}
...
<<<<<<< HEAD
    ...
    showToast('មិនអាចផ្ទុកទិន្នន័យបានទេ', 'error')
=======
...
<<<<<<< HEAD
.btn-orange { background: #ff5f00; color: #fff; border: none; border-radius: 10px; font-weight: 600; padding: 8px 18px; transition: background 0.2s, transform 0.15s; }
.btn-orange:hover { background: #e65600; color: #fff; transform: translateY(-1px); }
.btn-outline-navy { border: 1.5px solid #031c36; color: #031c36; border-radius: 10px; background: transparent; font-weight: 600; padding: 8px 14px; transition: all 0.2s; }
.btn-outline-navy:hover { background: #031c36; color: #fff; }
.btn-xs { font-size: 0.72rem; padding: 4px 10px; border-radius: 20px; }
.stat-card { transition: transform 0.25s, box-shadow 0.25s; border-top: 3px solid transparent; }
.stat-card:hover { transform: translateY(-4px); box-shadow: 0 12px 30px rgba(3,28,54,0.12) !important; border-top-color: #ff5f00; }
...
.bg-navy-light { background: rgba(3,28,54,0.08); color: #031c36; }
.trend-badge { font-size: 0.68rem; font-weight: 700; padding: 3px 8px; border-radius: 20px; }
.trend-up { background: #e9faf1; color: #198754; }
.trend-warn { background: #fff8e1; color: #f59e0b; }
.summary-chip { background: #f8f9fa; border-radius: 10px; padding: 10px; text-align: center; border: 1px solid #eee; }
.avg-price-box { background: #f8f9fa; border-radius: 12px; padding: 14px; text-align: center; border: 1px solid #eee; }
.donut-wrap { width: 130px; height: 130px; }
.donut-svg { width: 100%; height: 100%; transform: rotate(-90deg); }
.donut-ring { fill: none; stroke: #f0f2f5; stroke-width: 3.8; }
.donut-segment { fill: none; stroke-width: 3.8; stroke-linecap: round; transition: stroke-dasharray 0.6s; }
.seg-active { stroke: #198754; }
...
.status-pill { font-size: 0.68rem; font-weight: 700; padding: 3px 10px; border-radius: 20px; white-space: nowrap; }
...
.badge-count { background: rgba(255,95,0,0.2); color: #ff9a5c; font-size: 0.68rem; font-weight: 800; padding: 3px 8px; border-radius: 20px; }
.btn-action { width: 30px; height: 30px; border: none; border-radius: 8px; display: inline-flex; align-items: center; justify-content: center; font-size: 0.8rem; cursor: pointer; transition: all 0.2s; text-decoration: none; }
.btn-action.approve { background: #e9faf1; color: #198754; }
.btn-action.approve:hover:not(:disabled) { background: #198754; color: #fff; }
.btn-action.reject  { background: #ffebee; color: #e53935; }
.btn-action.reject:hover:not(:disabled)  { background: #e53935; color: #fff; }
.btn-action.edit    { background: #e7f1ff; color: #0d6efd; }
.btn-action.edit:hover { background: #0d6efd; color: #fff; }
.btn-action:disabled { opacity: 0.5; cursor: not-allowed; }
.action-box { display: flex; align-items: center; gap: 12px; padding: 10px 14px; background: #f8f9fa; border-radius: 12px; color: #031c36; border: 1.5px solid transparent; transition: all 0.2s; }
.action-box:hover { background: #fff; border-color: #ff5f00; transform: translateX(4px); box-shadow: 0 4px 16px rgba(255,95,0,0.1); color: #031c36; }
...
.skel-line { display: block; height: 14px; border-radius: 6px; background: linear-gradient(90deg, #f0f0f0 25%, #e0e0e0 50%, #f0f0f0 75%); background-size: 200% 100%; animation: shimmer 1.4s infinite; }
@keyframes shimmer { 0% { background-position: 200% 0; } 100% { background-position: -200% 0; } }
.provider-toast { position: fixed; bottom: 24px; right: 24px; z-index: 9999; display: flex; align-items: center; padding: 12px 20px; border-radius: 12px; font-weight: 700; font-size: 0.85rem; color: #fff; box-shadow: 0 8px 24px rgba(0,0,0,0.2); border-left: 4px solid rgba(255,255,255,0.3); }
.provider-toast.success { background: #031c36; }
.provider-toast.error   { background: #dc3545; }
...
.btn-orange { background:#ff5f00; color:#fff; border:none; border-radius:10px; font-weight:600; padding:8px 18px; transition:background .2s,transform .15s; }
.btn-orange:hover { background:#e65600; color:#fff; transform:translateY(-1px); }
.btn-outline-navy { border:1.5px solid #031c36; color:#031c36; border-radius:10px; background:transparent; font-weight:600; padding:8px 14px; transition:all .2s; }
.btn-outline-navy:hover { background:#031c36; color:#fff; }
...
.stat-label { font-size:.68rem; text-transform:uppercase; letter-spacing:.05em; }
.icon-shape { width:46px; height:46px; display:flex; align-items:center; justify-content:center; border-radius:12px; font-size:1.2rem; flex-shrink:0; }
.bg-orange-light  { background:#fff4ed; color:#ff5f00; }
.bg-primary-light { background:#e7f1ff; color:#0d6efd; }
.bg-success-light { background:#e9faf1; color:#198754; }
.bg-purple-light  { background:#f3e8ff; color:#8b5cf6; }
.bg-navy-light    { background:rgba(3,28,54,.08); color:#031c36; }
...
.donut-svg  { width:100%; height:100%; transform:rotate(-90deg); }
.donut-ring { fill:none; stroke:#f0f2f5; stroke-width:3.8; }
.donut-segment { fill:none; stroke-width:3.8; stroke-linecap:round; transition:stroke-dasharray .6s; }
.seg-active { stroke:#198754; }
.seg-promo  { stroke:#ff5f00; }
.donut-center { position:absolute; inset:0; display:flex; flex-direction:column; align-items:center; justify-content:center; }
.legend-dot { width:10px; height:10px; border-radius:50%; flex-shrink:0; }
...
.badge-count { background:rgba(255,95,0,.2); color:#ff9a5c; font-size:.68rem; font-weight:800; padding:3px 8px; border-radius:20px; }

.btn-action { width:30px; height:30px; border:none; border-radius:8px; display:inline-flex; align-items:center; justify-content:center; font-size:.8rem; cursor:pointer; transition:all .2s; text-decoration:none; }
.btn-action.approve { background:#e9faf1; color:#198754; }
.btn-action.approve:hover:not(:disabled) { background:#198754; color:#fff; }
.btn-action.reject  { background:#ffebee; color:#e53935; }
.btn-action.reject:hover:not(:disabled)  { background:#e53935; color:#fff; }
...
.action-box { display:flex; align-items:center; gap:12px; padding:10px 14px; background:#f8f9fa; border-radius:12px; color:#031c36; border:1.5px solid transparent; transition:all .2s; }
...
.action-icon { width:34px; height:34px; border-radius:10px; display:flex; align-items:center; justify-content:center; font-size:.9rem; flex-shrink:0; }
...
.provider-toast { position:fixed; bottom:24px; right:24px; z-index:9999; display:flex; align-items:center; padding:12px 20px; border-radius:12px; font-weight:700; font-size:.85rem; color:#fff; box-shadow:0 8px 24px rgba(0,0,0,.2); border-left:4px solid rgba(255,255,255,.3); }
.provider-toast.success { background:#031c36; }
.provider-toast.error   { background:#dc3545; }
