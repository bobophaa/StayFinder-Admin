    ...
    <div v-if="!user" class="row g-4">
      ...
      <div class="col-lg-8">
        <div class="card border-0 shadow-sm rounded-4 p-4">
          <div v-for="i in 5" :key="i" class="skel-line mb-3" :style="`width:${60+i*5}%;height:42px;border-radius:10px`"></div>
        </div>
      </div>
    </div>
    ...
    <div v-else>
      ...
      <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
        <div class="card-header-navy p-3 d-flex justify-content-between align-items-center flex-wrap gap-2">
          <div>
            <h4 class="fw-bold mb-0 text-white">Admin Profile</h4>
                ...
                <div class="row g-3">
                  ...
                  <div class="col-12">
                    ...
                    <div class="field-wrap" :class="{ 'readonly-wrap': !isEditing }">
                      ...
                      <input v-model="form.current_job" placeholder="e.g. System Administrator" :readonly="!isEditing" />
                    </div>
                  </div>
...
const quickLinks = [
  { to: '/admin/users',        label: 'Manage Users',   icon: 'bi-people-fill',      bg: 'ql-blue',   color: '#0d6efd' },
  { to: '/admin/room-options', label: 'Room Options',   icon: 'bi-ui-checks',        bg: 'ql-orange', color: '#ff5f00' },
  { to: '/admin/districts',    label: 'Districts',      icon: 'bi-geo-alt-fill',     bg: 'ql-green',  color: '#198754' },
  { to: '/admin',              label: 'Dashboard',      icon: 'bi-speedometer2',     bg: 'ql-navy',   color: '#031c36' },
]
...
.quick-link-item {
  ...
  padding: 11px 16px; color: #031c36;
